...
OUTPUT_KEY = 'part4/results_4.ndjson'
SKIPPED_KEY = 'part4/skipped_part4.json'
PROCESSED_DIR = 'part4/log4/'
...
with open(local_csv, "r", encoding="utf-8") as f:
    for line in f:
        ...
        if len(batch) >= BATCH_SIZE:
            ...
            print(f"{counter} | Found: {found} | Skip: {len(skipped)} | {rate:.0f}/s")
            ...
            if counter % SAVE_EVERY == 0:
                ...
                processed_log = []
                print(f"Checkpoint {chunk_num} saved!")
...
print(f"Done! {counter} | Found: {found} | Skip: {len(skipped)} | {(time.time() - start_time) / 3600:.1f}h")